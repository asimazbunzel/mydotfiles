...
keymap.set("n", "ss", ":nohl<CR>", { desc = "Clear search highlights" })
...
keymap.set("n", "<S-Tab>", ":bprev<enter>", { desc = "Go to prev buffer" })
keymap.set("n", "<leader>x", ":bdelete<enter>", { desc = "Quit current buffer" })
